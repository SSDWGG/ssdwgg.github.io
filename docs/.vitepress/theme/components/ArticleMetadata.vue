...
<template>
    <div class="word">
        <p>
            ...
            {{ messages.article.updated }}: {{ date.toLocaleDateString(messages.dateLocale) }}
            ...
            {{ messages.article.words }}: {{ wordCount }} {{ messages.article.wordUnit }}
            ...
            {{ messages.article.readingTime }}: {{ readTime }} {{ messages.article.minuteUnit }}
        </p>
    </div>
</template>

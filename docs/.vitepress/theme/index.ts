...
import svgaList from './components/svgaList.vue'
import shakeKun from './components/shakeKun/index.vue'
import xlgx from './components/xlgx/index.vue'
import ChristmasTree from './components/ChristmasTree.vue' // 圣诞树
...
export default {
  ...
  enhanceApp({ app, router }) {
    ...
    app.component('SvgaPlayer', SvgaPlayer)
    app.component('svgaList', svgaList)
    app.component('shakeKun', shakeKun)
    app.component('xlgx', xlgx)
